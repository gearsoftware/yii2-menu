...
{
    public $modelClass = 'gearsoftware\models\Menu';
    public $modelSearchClass = 'gearsoftware\menu\models\search\SearchMenu';
    public $modelLinkSearchClass = 'gearsoftware\menu\models\search\SearchMenuLink';
